...
export const products: Product[] = [
  { id: 1, name: 'Product 1', price: 1, image: '/products/alphabet_keychains.webp', description: 'Description for Product 1' },
  { id: 2, name: 'Product 2', price: 1, image: '/products/ganesha_resin.webp', description: 'Description for Product 2' },
  { id: 3, name: 'Product 3', price: 1, image: '/products/key_holder.webp', description: 'Description for Product 3' },
